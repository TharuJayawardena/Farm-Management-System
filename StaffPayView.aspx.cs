    ...
    public partial class WebForm20 : System.Web.UI.Page
    {
        ...
        void getMemberByID()
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from StaffPayments where PID ='" + TextBox1.Text.Trim() + "' ", con);
        ...
        void deleteMemberByID()
        {
            if (checkIfMemberExists())
            {
                try
                {
                    ...
                    SqlCommand cmd = new SqlCommand("DELETE from StaffPayments WHERE PID='" + TextBox1.Text.Trim() + "'", con);
        ...
        {
            SqlConnection con = new SqlConnection(strcon);
            SqlCommand sqlcomm = new SqlCommand("updateStatus", con);
