<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="fruit aspx.aspx.cs" Inherits="E_Farming.WebForm25" %>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <asp:Button ID="Button3" class="btn btn-success" runat="server" Text="Calculate total" OnClick="Button3_Click" /><br />
                            <div class="col-md-3">
                                <label>Total</label>&nbsp;<div class="form-group">
                                    <asp:TextBox CssClass="form-control" ID="txtTotal" Width="100px" runat="server" ReadOnly="True"></asp:TextBox>
            ...
            <div class="col-md-7">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col">
                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString4 %>" SelectCommand="SELECT [id], [itemName], [price], [img_link] FROM [item_management]" ProviderName="<%$ ConnectionStrings:ConnectionString4.ProviderName %>">
                               </asp:SqlDataSource>
                       ...
                       <div class="row">
                           <div class="col">
                               <asp:GridView class="table table-striped table-bordered" ID="EGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" OnSelectedIndexChanged="EGridView1_SelectedIndexChanged">
                                  <Columns>
