<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="vegitable aspx.aspx.cs" Inherits="E_Farming.WebForm30" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString4 %>" SelectCommand="SELECT * FROM [item_management] WHERE ([Catagories] = ?)" ProviderName="<%$ ConnectionStrings:ConnectionString4.ProviderName %>">
<SelectParameters>
<asp:QueryStringParameter DefaultValue="Vegitables" Name="Catagories" QueryStringField="Vegitables" Type="String" />
</SelectParameters>
</asp:SqlDataSource>
