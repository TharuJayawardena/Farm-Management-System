...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<div class="container-fluid">
                  ...
                  <div class="row">
                   ...
                   <div class = "row">
                       <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString2 %>" ProviderName="<%$ ConnectionStrings:ConnectionString2.ProviderName %>" 
                           SelectCommand="SELECT [full_name], [contact_no], [email], [state], [city], [customerNo], [full_address], [customer_id] FROM [Customer_Table_1]"></asp:SqlDataSource>
     ...
     </div><a href="AdminManagement.aspx"><i> << Goto Home</i></a><br /><br><br><br><br><br><br><br>
   <br>
